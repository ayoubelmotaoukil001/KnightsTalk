<x-guest-layout>
    <h2 class="text-2xl font-bold text-white text-center mb-1">Create your account</h2>
    <p class="text-gray-500 text-sm text-center mb-6">Start your chess journey today</p>

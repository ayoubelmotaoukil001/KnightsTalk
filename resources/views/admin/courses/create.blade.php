<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-white leading-tight">Create Course</h2>
    </x-slot>
    ...
    <div class="py-8 px-4 max-w-2xl mx-auto">
        ...
        <form method="POST" action="{{ route('admin.courses.store') }}" class="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full bg-white/5 border border-white/10 text-white rounded-xl px-4 py-3 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 placeholder-gray-500 transition-all duration-200">{{ old('description') }}</textarea>
